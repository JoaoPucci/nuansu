...
5. **security.md** + **compliance.md** to understand non-negotiables baked into the design.
6. **deployment.md** when you're ready to provision.
7. **questions.md** to see what's still pending founder input.

## Status

- Date: 2026-04-26
- Phase: Planning resolved — vendor stack locked, pre-implementation
