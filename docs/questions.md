...
| Free-tier model: Sonnet 4.6 for everyone, gated by 10/day rolling-24h quota                                                                                                                                                                                                                                             | [`back_end_architecture.md §5.5`](./back_end_architecture.md)                                              |
...
**v1 decision: not shipping.** Pinned to Anthropic Sonnet 4.6 (outbound) + Haiku 4.5 (inbound preview, back-translation). See [`back_end_architecture.md §5.5`](./back_end_architecture.md).
